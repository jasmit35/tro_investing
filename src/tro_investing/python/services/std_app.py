...
---------------------------------------------------------------------------------------------------------------------
  ...
  1. called after the default values are set and before the command line parameters 
     are processed. This allows the app to have values that are set in the config file that can be overridden by 
     the command line parameters.

  2. set_command_line_values() - This method is expected to process the command line parameters and set the values 
